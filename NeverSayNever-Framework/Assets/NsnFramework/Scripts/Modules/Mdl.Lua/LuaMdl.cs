...
namespace NeverSayNever
{
    public class LuaMdl : ILuaMdl
    {
        ...
        public  void OnCreate(params object[] args)
        {
            ...
            {
                var luaFilePath = Framework.GlobalConfig.LuaSciprtDirectory;
        ...
        {
            Framework.GetModule<IResMdl>().LoadTextAsset(name, (obj) =>
            {
            ...
            // 这里是直接加载bundle，但是改了结构后 ab的代码有访问限制了，先用上面的方法临时处理下
