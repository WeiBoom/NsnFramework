...
namespace NeverSayNever.Abosolute
{
    public class EventManager_abosolute : EventDispatcher
    {
        private static EventManager_abosolute _inst;
        private static EventManager_abosolute Inst => _inst ?? (_inst = new EventManager_abosolute());
